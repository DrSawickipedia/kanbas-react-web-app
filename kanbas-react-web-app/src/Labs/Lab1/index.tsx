    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          ...
          <li>
            Slice raw ingredients as necessary so that they will fit in the
            sandwich
          </li>
          <li>Put one slice of bread on the cooking surface</li>
          <li>
            Layer ingredients on top of the bread one after the other, stopping
            at various sandwich components to spread any desired sauces/similar
            ingredients
          </li>
          <li>Place the other slice of bread on the top of the sandwich</li>
          <li>Consume in order to postpone death by malnutrition</li>
        </ol>
